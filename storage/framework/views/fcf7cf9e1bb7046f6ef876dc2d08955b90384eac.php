...
<html>
    <head>
        ...
        <link href="<?php echo e(URL::to('src/css/jquery.tagsinput.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <?php echo $__env->make('admin/includes/edit_image', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div><!-- ./wrapper -->
        ...
        <script src="<?php echo e(URL::to('src/js/jquery.tagsinput.js')); ?>" type="text/javascript"></script>
